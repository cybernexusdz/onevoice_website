...
const Header = () => {
  ...
  const goldGradient = "bg-gradient-to-r from-[#F3E5AD] via-[#D4AF37] to-[#C5A059]";
  const darkLink = "text-[#1A1608] hover:text-black transition-all duration-300 font-bold uppercase tracking-widest text-[11px]";
    ...
    >
      ...
      <div className="flex justify-between items-center p-5 max-w-7xl mx-auto">
        ...
        <div className="hidden md:flex gap-10 items-center">
          <a href="#home" className={darkLink}>Home</a>
          <a href="#about" className={darkLink}>About us</a>
          <a href="#activity" className={darkLink}>Activity</a>
          <a href="#events" className={darkLink}>Events</a>
          <a href="#contact" className={darkLink}>Contact</a>
        </div>
        ...
        <div className="flex items-center gap-5 text-[#1A1608]">
          <div className="hidden sm:flex items-center gap-4 border-r border-[#1A1608]/20 pr-5">
            ...
            <Globe size={18} className="cursor-pointer hover:scale-110 transition-transform" />
            <User size={18} className="cursor-pointer hover:scale-110 transition-transform" />
          </div>
      ...
      `}>
        ...
        <div className="flex flex-col items-center py-8 gap-6">
          ...
          <a href="#activity" onClick={() => setIsMenuOpen(false)} className={darkLink}>Activity</a>
          <a href="#events" onClick={() => setIsMenuOpen(false)} className={darkLink}>Events</a>
          <a href="#contact" onClick={() => setIsMenuOpen(false)} className={darkLink}>Contact</a>
        </div>
      </div>
    </nav>
  );
